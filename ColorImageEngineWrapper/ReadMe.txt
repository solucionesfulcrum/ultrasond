========================================================================
    BIBLIOTECA DE VÍNCULOS DINÁMICOS: ColorImageEngineWrapper Información general del proyecto
========================================================================

AppWizard ha creado este archivo DLL ColorImageEngineWrapper.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación ColorImageEngineWrapper.

ColorImageEngineWrapper.vcxproj
...
ColorImageEngineWrapper.vcxproj.filters
...
ColorImageEngineWrapper.cpp
    Este es el archivo de código fuente DLL principal.

ColorImageEngineWrapper.h
